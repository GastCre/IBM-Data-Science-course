...
# Plot 3 Pie chart for total expenditure share by vehicle type during recessions
	...
	# Hint:Use Vehicle_Type and Advertising_Expenditure columns
        ...
        R_chart3 = dcc.Graph(figure=px.pie(exp_rec, values='Advertising_Expenditure', names='Vehicle_Type', title="Total advertising expenditure during recession by vehicle type "
        )
        )
